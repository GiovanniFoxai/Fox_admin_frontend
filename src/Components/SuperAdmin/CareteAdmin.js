          ...
          <div className='create-company-section' >
            <div className='create-company-form' >
              <form className='form-create'>
                ...
                <label className="form-lable" for="email">Email</label>
                <input className="form-input" type="email" id="email" />
                <label className="form-lable" for="start">Password</label>
                <input className="form-input" type="password" id="pasword" />
