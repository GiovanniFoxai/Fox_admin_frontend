...
import { saveChatId, saveChatList, saveConversationList, saveNewChats, savePrevChats } from '../Redux/Reducers/appSlice';
...
const Home = (props) => {
  ...
  const { prevChats, chatId, newChats, conversationList } = useSelector(state => state.app)
  ...
  const handleNavCloseButtonClick = () => {
    document.querySelector('.nav--container').classList.remove('active--toggle');
  }
    ...
    <section className="main-section">
      <div className="container">
        ...
        <div className="open--toggle">
          <button type="button" onClick={handleNavActiveClick} className="inline-flex h-11 w-11 items-center justify-center rounded-md border border-white/20 text-white hover:bg-gray-500/10 toggle--active" id="nav-menu-close-btn">
        ...
        <div className={`black--section nav--container ${shouldRemoveClass ? '' : 'active--toggle'} ${shouldAddClass ? '' : 'active--toggle'}`}>
                ...
                <nav className="relative flex h-full flex-1 flex-col space-y-1 p-2">
                  <div className="top--nav">
                    ...
                    <button type="button"
                      ...
                      id="nav-menu-close-btn" onClick={handleNavCloseButtonClick}>
                      <span className="sr-only">Close sidebar</span>
                      <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24"
                        strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4" height="1em" width="1em"
                        xmlns="http://www.w3.org/2000/svg">
            ...
            <>
              ...
              <div className="capabilities--cont">
                ...
                <ul className="capailitie-list">
                  <li className="">Remembers what user said earlier in the conversation</li>
                  <li className="">Allows user to provide follow-up corrections</li>
                  <li className="">Trained to decline inappropriate requests</li>
                </ul>
              </div>
            </>}
              ...
              <div className="openAIOptions-simple-container">
                ...
                {isToggleVisible && (
                  <div className="toggle--up--show" style={{ "opacity": 1 }}>
                    <div className="endpointOptionsPopover-container show" id="filterbox">
                      <div className="pop-up-box">
                        <div className="up-inner-box">
                          <button
                            ...
                            type="button" id="cross_icon"><svg stroke="currentColor" fill="none" strokeWidth="2"
                              viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4"
                              height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="grid w-full items-center gap-2">
                              <div className="items-center justify-center gap-2 flex w-full resize-none">
                                <div className="inner-box-btn">
                                  <button
                                    className="m-text"
                                    id="headlessui-listbox-button-:ra:" type="button" aria-haspopup="listbox"
                                    aria-expanded="false" data-headlessui-state=""
                                    aria-labelledby="headlessui-listbox-label-:r1: headlessui-listbox-button-:ra:"
                                    fdprocessedid="4ns6y"> <label
                                      className="block text-xs text-gray-700 dark:text-gray-500"
                                      data-headlessui-state=""
                                      id="headlessui-listbox-label-:r1:">Company</label><span
                                        className="inline-flex w-full truncate"><span
                                          className="flex h-6 items-center gap-1 truncate text-sm text-gray-900 dark:text-white">text-davinci-003</span></span></button>
                                </div>
                              </div>
                            </div>
                            <div className="grid w-full items-center gap-2">
                              <div className="items-center justify-center gap-2 flex w-full resize-none">
                                <div className="relative w-full">
                                  <button className="m-text dropdown--up" id="open_drop_down_btn" type="button" onClick={() => settoggelDropdown(!toggelDropdown)} aria-haspopup="listbox"
                                    aria-expanded="true" data-headlessui-state="open"
                                    aria-labelledby="headlessui-listbox-label-:r1: headlessui-listbox-button-:ra:"
                                    fdprocessedid="bgy91" aria-controls="headlessui-listbox-options-:r7m:">
                                    <div>
                                      <label className="block text-xs text-gray-700 dark:text-gray-500"
                                        data-headlessui-state="open"
                                        id="headlessui-listbox-label-:r1:">Model</label>
                                      <span className="inline-flex w-full truncate"><span
                                        className="flex h-6 items-center gap-1 truncate text-sm text-gray-900 dark:text-white">text-davinci-003</span></span>
                                    </div>
                                    <span
                                      className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2"><svg
                                        ...
                                        className="h-4 w-4  text-gray-400" height="1em" width="1em"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <polyline points="6 9 12 15 18 9"></polyline>
                                      </svg></span>
                                  </button>
                                  <ul className={`display_none drop-li dropdown--item ${toggelDropdown ? `active` : ''}`} id="close_drop_down_btn" role="listbox">
                                    <li className="group relative flex h-[42px] cursor-pointer select-none items-center overflow-hidden border-b border-black/10 pl-3 pr-9 text-gray-900 last:border-0 hover:bg-[#ECECF1] dark:border-white/20 dark:text-white dark:hover:bg-gray-700"
                                      id="headlessui-listbox-option-:r7n:" role="option" tabIndex="-1"
                                      aria-selected="false" data-headlessui-state=""><span
                                        className="flex items-center gap-1.5 truncate"><span
                                          className="flex h-6 items-center gap-1 text-gray-800 dark:text-gray-100">gpt-3.5-turbo-16k-0613</span></span>
                                    </li>
                                    <li className="group relative flex h-[42px] cursor-pointer select-none items-center overflow-hidden border-b border-black/10 pl-3 pr-9 text-gray-900 last:border-0 hover:bg-[#ECECF1] dark:border-white/20 dark:text-white dark:hover:bg-gray-700"
                                      id="headlessui-listbox-option-:r7o:" role="option" tabIndex="-1"
                                      aria-selected="true" data-headlessui-state="selected"><span
                                        className="flex items-center gap-1.5 truncate"><span
                                          className="flex h-6 items-center gap-1 text-gray-800 dark:text-gray-100 font-semibold">text-davinci-003</span><span
                                            className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-800 dark:text-gray-100"><svg
                                              stroke="currentColor" fill="none" strokeWidth="2"
                                              viewBox="0 0 24 24" strokeLinecap="round"
                                              strokeLinejoin="round" className="h-4 w-4" height="1em"
                                              width="1em" xmlns="http://www.w3.org/2000/svg">
                                            <polyline points="20 6 9 17 4 12"></polyline>
                                          </svg></span></span></li>
                                    <li className="group relative flex h-[42px] cursor-pointer select-none items-center overflow-hidden border-b border-black/10 pl-3 pr-9 text-gray-900 last:border-0 hover:bg-[#ECECF1] dark:border-white/20 dark:text-white dark:hover:bg-gray-700"
                                      id="headlessui-listbox-option-:r7p:" role="option" tabIndex="-1"
                                      aria-selected="false" data-headlessui-state=""><span
                                        className="flex items-center gap-1.5 truncate"><span
                                          className="flex h-6 items-center gap-1 text-gray-800 dark:text-gray-100">gpt-3.5-turbo</span></span>
                                    </li>
                                    <li className="group relative flex h-[42px] cursor-pointer select-none items-center overflow-hidden border-b border-black/10 pl-3 pr-9 text-gray-900 last:border-0 hover:bg-[#ECECF1] dark:border-white/20 dark:text-white dark:hover:bg-gray-700"
                                      id="headlessui-listbox-option-:r7q:" role="option" tabIndex="-1"
                                      aria-selected="false" data-headlessui-state=""><span
                                        className="flex items-center gap-1.5 truncate"><span
                                          className="flex h-6 items-center gap-1 text-gray-800 dark:text-gray-100">gpt-3.5-turbo-0301</span></span>
                                    </li>
                                    <li className="group relative flex h-[42px] cursor-pointer select-none items-center overflow-hidden border-b border-black/10 pl-3 pr-9 text-gray-900 last:border-0 hover:bg-[#ECECF1] dark:border-white/20 dark:text-white dark:hover:bg-gray-700"
                                      id="headlessui-listbox-option-:r7r:" role="option" tabIndex="-1"
                                      aria-selected="false" data-headlessui-state=""><span
                                        className="flex items-center gap-1.5 truncate"><span
                                          className="flex h-6 items-center gap-1 text-gray-800 dark:text-gray-100">gpt-3.5-turbo-16k</span></span>
                                    </li>
                                    <li className="group relative flex h-[42px] cursor-pointer select-none items-center overflow-hidden border-b border-black/10 pl-3 pr-9 text-gray-900 last:border-0 hover:bg-[#ECECF1] dark:border-white/20 dark:text-white dark:hover:bg-gray-700"
                                      id="headlessui-listbox-option-:r7s:" role="option" tabIndex="-1"
                                      aria-selected="false" data-headlessui-state=""><span
                                        className="flex items-center gap-1.5 truncate"><span
                                          className="flex h-6 items-center gap-1 text-gray-800 dark:text-gray-100">gpt-3.5-turbo-0613</span></span>
                                    </li>
                    ...
                    <div className="search-part">
                      ...
                      <div className="search-text">
                        <textarea onKeyDown={handleKeyDown}
                          rows={textareaheight} value={newChat} onChange={handleChange} ></textarea>
                      </div>
                      <div className="file-add-btn">
                        <label htmlFor="file"><svg stroke="currentColor" fill="none" strokeWidth="2"
                          viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"
                      ...
                      <div className="share-btn">
                        <button disabled={!newChat} type='submit' className="">
                          <div className=" ">
                            <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24"
                              strokeLinecap="round" strokeLinejoin="round" className="mr-1 h-4 w-4 "
                              height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
