                        ...
                        <div className="drop-up-area">
                            <div className="openAIOptions-simple-container">
                                <div className="model-selector">
                                    <button
                                        onClick={() =>
                                            setActiveDropdownGpt(
                                                !activeDropdownGpt
                                            )
                                        }
                                        className=" model-text dropdown--up"
                                        id="openbox"
                                        type="button"
                                    >
                                    ...
                                    <ul
                                        className={`display_none drop--up dropdown--item ${
                                            activeDropdownGpt ? "active" : ""
                                        }`}
                                        id="openbox_data"
                                    >
                                        <li
