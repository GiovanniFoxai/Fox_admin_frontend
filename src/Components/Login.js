          ...
          <form onSubmit={handleSubmit} className="" aria-label="Login form" method="POST">
            <div className="area-entry">
              <div className="email-area">
                <input type="mail" required id="email" autoComplete="email" aria-label="Email" name="email" onChange={handleChange}
                  value={data.email} aria-invalid="false" className="" placeholder="Email address" fdprocessedid="g89qhl" />
                {/* <label for="email" className=" ">Email address</label></div> */}
              </div>
              <div className="email-area">
                <div className="relative"><input minLength={minUserPasswordLength} type="password" required onChange={handleChange}
                  value={data.password} id="password" autoComplete="current-password" aria-label="Password" name="password" aria-invalid="false" className=" " placeholder="Password" fdprocessedid="ugqpqh" />
